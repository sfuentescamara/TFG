...
def game():
    ...
    speed = [1, 1]
    white = 255, 255, 255
    # Crea un objeto imagen pelota y obtengo su rectangulo
    ball = pygame.image.load('ball.png')
    ballrect = ball.get_rect()
    # Crea un objeto imagen bate y obtengo su rectangulo
    bate = pygame.image.load('bate.png')
    baterect = bate.get_rect()
    # Pongo el bate en el centro de la pantalla
    baterect.move_ip(400, 300)
    run_juego = True
    while run_juego:
        pygame.time.delay(2)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT: run_juego = False
        ...
        def loop(self, run):
            while run:
                ...
                if self.state==STATE_INTRO:
                    ...
                    option.draw(3,0)
                    self.printSmall("Author: Dominik",40,130)
